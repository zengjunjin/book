          ...
          <svg viewBox="0 0 32 32" class="logo-svg">
            <defs>
              <linearGradient id="lg1" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style="stop-color:var(--accent, #2563eb)"/>
                <stop offset="50%" style="stop-color:var(--accent-light, #3b82f6)"/>
                <stop offset="100%" style="stop-color:var(--accent-cyan, #0891b2)"/>
              </linearGradient>
            </defs>
        ...
        <div v-if="aiThinking" class="msg-row ai thinking">
          <div class="msg-avatar ai">
            <svg viewBox="0 0 24 24" width="18" height="18">
              <circle cx="12" cy="12" r="11" fill="var(--accent, #2563eb)" opacity="0.25"/>
              <circle cx="12" cy="12" r="11" fill="none" stroke="var(--accent, #2563eb)" stroke-width="1.5" opacity="0.8"/>
              <text x="12" y="16" text-anchor="middle" font-size="11">🤖</text>
            </svg>
          </div>
          <div class="msg-body">
...
// 封面颜色
const palettes = [
  ['var(--accent, #2563eb)', 'var(--accent-light, #3b82f6)'], ['#ec4899', '#f97316'], ['var(--accent-cyan, #0891b2)', '#22c55e'],
  ['#f59e0b', '#ef4444'], ['#8b5cf6', 'var(--accent-cyan, #0891b2)'], ['#10b981', 'var(--accent-light, #3b82f6)'],
...
.orb-2 {
  ...
  background: radial-gradient(circle, var(--accent-cyan, #0891b2) 0%, transparent 70%);
  top: 30%; right: -120px;
  animation-delay: -6s;
}
.orb-3 {
  width: 440px; height: 440px;
  background: radial-gradient(circle, var(--accent-light, #3b82f6) 0%, transparent 70%);
...
.bg-noise {
  ...
  inset: 0;
  pointer-events: none;
  background-image: radial-gradient(var(--bg-card, #ffffff) 1px, transparent 1px);
...
.logo-svg { width: 42px; height: 42px; filter: drop-shadow(0 4px 14px rgba(37, 99, 235, 0.3)); }
.brand-text .brand-title {
  font-size: 17px; font-weight: 700;
  background: linear-gradient(135deg, #fff 0%, var(--accent, #2563eb) 60%, var(--accent-cyan, #0891b2) 100%);
  -webkit-background-clip: text; -webkit-text-fill-color: transparent;
  background-clip: text;
  letter-spacing: 0.3px;
}
.brand-sub {
  font-size: 12px; color: var(--text-muted, #94a3b8); margin-top: 2px; display: flex; align-items: center; gap: 6px;
}
.status-dot {
...
.chat-main::-webkit-scrollbar-thumb { background: var(--border-color, #e2e8f0); border-radius: 3px; }
.chat-main::-webkit-scrollbar-thumb:hover { background: rgba(37, 99, 235, 0.25); }
...
.welcome-hero h1 {
  ...
  margin: 0 0 10px;
  background: linear-gradient(135deg, #fff 0%, var(--accent, #2563eb) 50%, var(--accent-cyan, #0891b2) 100%);
  -webkit-background-clip: text; -webkit-text-fill-color: transparent;
  background-clip: text;
  letter-spacing: -0.5px;
}
.hero-sub { color: var(--text-muted, #94a3b8); font-size: 14px; margin: 0; }
...
.prompt-text { flex: 1; font-size: 13.5px; color: var(--text-primary, #1e293b); font-weight: 500; line-height: 1.45; }
.prompt-arrow { color: var(--text-secondary, var(--accent, #2563eb)); font-size: 16px; transition: transform 0.2s, color 0.2s; font-weight: 600; }
.prompt-card:hover .prompt-arrow { color: var(--accent, #2563eb); transform: translateX(4px); }
...
.hot-title { font-size: 15px; font-weight: 600; color: var(--text-primary, #1e293b); }
.hot-sub { font-size: 12px; color: var(--text-muted, #94a3b8); }
...
.hbc-author { font-size: 11.5px; color: var(--text-muted, #94a3b8); }
...
.msg-avatar.user {
  background: linear-gradient(135deg, var(--accent, #2563eb) 0%, var(--accent-light, #3b82f6) 100%);
  color: var(--text-primary, #1e293b);
  border: 1px solid var(--border-color, #e2e8f0);
}
.msg-avatar.ai {
...
.msg-sender { font-weight: 600; color: var(--text-secondary, var(--accent, #2563eb)); font-size: 12px; }
.msg-time { color: var(--text-muted, #94a3b8); }
.msg-intent {
  padding: 2px 8px;
  background: rgba(37, 99, 235, 0.12);
...
.msg-row.user .msg-bubble {
  background: linear-gradient(135deg, rgba(37, 99, 235, 0.15) 0%, rgba(8, 145, 178, 0.12) 100%);
...
.msg-bubble.typing .caret {
  ...
  background: var(--accent, #2563eb); vertical-align: text-bottom;
  margin-left: 2px;
...
.bc-author { font-size: 11.5px; color: var(--text-muted, #94a3b8); }
.bc-meta { font-size: 11px; color: var(--text-muted, #94a3b8); display: flex; gap: 6px; align-items: center; flex-wrap: wrap; }
.meta-dot::before { content: '·'; margin-right: 6px; color: var(--text-muted, #94a3b8); }
.bc-tag {
  margin-top: auto;
  padding: 3px 8px;
...
.thinking-box {
  ...
  border-radius: 18px;
  font-size: 13.5px;
  color: var(--text-secondary, var(--accent, #2563eb));
}
.thinking-dots { display: inline-flex; gap: 4px; }
.thinking-dots span {
  width: 6px; height: 6px;
  background: linear-gradient(135deg, var(--accent, #2563eb), var(--accent-cyan, #0891b2));
  border-radius: 50%;
...
.chat-textarea::placeholder { color: var(--text-muted, #94a3b8); }
